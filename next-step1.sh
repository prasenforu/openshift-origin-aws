...
ssh centos@$node -i prasen.pem "sudo sed -i 's/PermitRootLogin no/PermitRootLogin yes/g' /etc/ssh/sshd_config"
...
#scp /root/openshift-origin-aws/open311-gluster.repo $node:/etc/yum.repos.d/ocp311gluster.repo
