    ...
    curl --user $SNUSER:$SNPASS \
     ...
     --request POST \
     --data '{"short_description":"In OCP '"$hst"' '"$summ"'","caller_id":"'"$SNCALLID"'","urgency":"'"$pri"'","category":"'"$SNCATAGORY"'","assignment_group":"'"$SNASSINGRP"'","assigned_to":"'"$SNASSINTO"'","sys_created_by":"'"$SNCALLID"'"}' \
